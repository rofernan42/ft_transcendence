...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post friends_url, params: { friend: { user_one_id: @friend.user_one_id, user_two_id: @friend.user_two_id } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { user_one_id: @friend.user_one_id, user_two_id: @friend.user_two_id } }
